...
For information on using custom CA certificates, or renewing the self-signed CA certificates, see the xref:cli/certificate123.adoc#_certificate_authority_ca_certificates[`k3s certificate rotate-ca` command documentation].
...
For more information, see the xref:cli/token.adoc#test_header[`k3s token` command documentation].
