...
For information on manually rotating client and server certificates, see the xref:cli/certificate2.adoc#_client_and_server_certificates[`k3s certificate rotate` command documentation].
...
For more information, see the xref:cli/certificate.adoc#_test_header123[`k3s token` command documentation].
